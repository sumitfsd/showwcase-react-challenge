...
import { Header, Content, Wrapper, Title, StyledModal, Footer, CloseButton } from './Modal.styled'
import Button from '../Button'
import { AiFillCloseCircle } from 'react-icons/ai'

const Modal = ({ isOpen, onRequestClose, header, footer, hasFixedHeader = false, height, width, children }) => {
  return (
    <StyledModal
      height={height}
      width={width}
    ...
    >
      <Wrapper>
        ...
        <Content hasFixedHeader={hasFixedHeader}>
          {children}
        </Content>
